...
(function( $, window, document, undefined ) {
    ...
    $.fn.socialfeed = function(options)
    {
        var defaults = {
            ...
            template: 'html/twitter.html', // a path to the tamplate file
        ...
        function getTwitterData(){
            var tw_json = 'https://script.google.com/macros/s/AKfycbz8KOO24nDKJf4jK36wlhK1rHNj9QO5XB0JHUQP_b9dUoPC4H3x/exec?action=timeline&q=' + options.tw_username + '&callback=?';
            $.ajax({
                url:tw_json,
                dataType:'json',
                timeout:1000,
        ...
        function getTemplate(data){
            ...
            content.social_icon = options.plugin_folder + 'images/' + data.social_network + '-icon-24.png';
